...
const Believe = () => {
  return (
    ...
    <>
        <div className=" w-full aspect-[4/1] p-10">
            <div className="text-white">
                    <div className="text-2xl lg:text-6xl sectionHeader2">
                        We believe in 
                        <span className="text-[#F36F2B]"> diversity & inclusion</span>
                    </div>
            </div>
        </div>
        <div className=" w-full aspect-[4/1] p-10 flex flex-col gap-8 ">
            <p className="sectionPara2 lg:text-xl">
            ...
            <p className="sectionSpacing2 lg:text-2xl">
